...
class Books_Categories(models.Model):
    bcname = models.CharField(max_length=255, blank=False, db_index=True, unique=True, help_text='Название категории книг.', verbose_name = "Название категории книг")
...
class Books_Author(models.Model):
    baauthor = models.CharField(max_length=255, blank=False, db_index=True, unique=True, help_text='Автор книг', verbose_name = "Имя автора книг")
    def __str__(self):
