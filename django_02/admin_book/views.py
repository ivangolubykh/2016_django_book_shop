...
from admin_book.forms import Edit_Book_Author, Edit_Book_Categories, Edit_Books
        ...
        if request.method == "POST" and request.is_ajax:
            ...
            if change_data == 'book_author_list':
                ...
                if add_form.is_valid():
                    add_form.save()
                    return render(request, 'admin_book/admin_box_books_authors_list.html', {'form_author_add': Edit_Book_Author(), 'author_list': authors})
                return render(request, 'admin_book/admin_box_books_authors_list.html', {'form_author_add': add_form, 'author_list': authors})
                ...
                return render(request, 'admin_book/admin_box_books_author_editing.html', {'form_author_edit': Edit_Book_Author(instance=author), 'id': edit_id})
                ...
                if form.is_valid():
                    ...
                    return render(request, 'admin_book/admin_box_books_author_info.html', {'author': author})
                else:
                    return render(request, 'admin_book/admin_box_books_author_editing.html', {'form_author_edit': form, 'id': edit_id})
            ...
            return render(request, 'admin_book/adminn_books_authors.html', {'form_author_add': Edit_Book_Author(), 'author_list': authors})
    ...
    if Veryfy_Admin_Autorizations(request):
        ...
        if request.method == "POST" and request.is_ajax:
            ...
            if change_data == 'book_categor_list':
                ...
                if add_form.is_valid():
                    add_form.save()
                    return render(request, 'admin_book/admin_box_books_categor_list.html', {'form_categor_add': Edit_Book_Categories(), 'categor_list': categories})
                return render(request, 'admin_book/admin_box_books_categor_list.html', {'form_categor_add': add_form, 'categor_list': categories})
                ...
                return render(request, 'admin_book/admin_box_books_categor_editing.html', {'form_categor_edit': Edit_Book_Categories(instance=categor), 'id': edit_id})
                ...
                if form.is_valid():
                    ...
                    return render(request, 'admin_book/admin_box_books_categor_info.html', {'categor': categor})
                else:
                    return render(request, 'admin_book/admin_box_books_categor_editing.html', {'form_categor_edit': form, 'id': edit_id})
            ...
            return render(request, 'admin_book/adminn_books_categor.html', {'form_categor_add': Edit_Book_Categories(), 'categor_list': categories})
    ...
    if Veryfy_Admin_Autorizations(request):
        ...
        if request.method == "POST" and request.is_ajax:
            ...
            if change_data == 'book_list':
                ...
                if add_form.is_valid():
                    add_form.save()
                    return render(request, 'admin_book/admin_box_books_list.html', {'form_book_add': Edit_Books(), 'books_list': books})
                return render(request, 'admin_book/admin_box_books_list.html', {'form_book_add': add_form, 'books_list': books})
                ...
                return render(request, 'admin_book/admin_box_books_editing.html', {'form_book_edit': Edit_Books(instance=books), 'id': edit_id})
                ...
                if form.is_valid():
                    ...
                    return render(request, 'admin_book/admin_box_books_info.html', {'book': book})
                else:
                    return render(request, 'admin_book/admin_box_books_editing.html', {'form_book_edit': form, 'id': edit_id})
            ...
            return render(request, 'admin_book/adminn_books.html', {'form_book_add': Edit_Books(), 'books_list': books})
